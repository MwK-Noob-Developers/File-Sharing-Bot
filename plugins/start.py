...
@Bot.on_message(filters.regex("http") | filters.regex("www") | filters.regex("t.me") | filters.regex("ib") | filters.regex("pm") | filters.regex("dm") | filters.regex("fuck") | filters.regex("veno") | filters.regex("kitti") | filters.regex("sex") | filters.regex("vendevar") ~ filters.user(ADMINS))
